...
[source,execute]
----
cat persistent-storage/persistentvolumeclaim.yaml
----
...
[source,execute]
----
kubectl apply -f persistent-storage/persistentvolumeclaim.yaml
----
...
[source,execute]
----
cat persistent-storage/deployment.yaml
----
...
[source,execute]
----
kubectl apply -f persistent-storage/deployment.yaml
----
