...
Again, we can use `kubectl` to create an ingress resource. This looks a little complicated, but we will break it down and explain it.
...
You should now see the start of our parksmap application!
